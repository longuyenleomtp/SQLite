...
public class ShowListCategoryActivity2 extends ListActivity{
    ...
    public void updateUI()
    {
        ...
        if(database!=null)
        {
            ...
            cursor.close();
            MySimpleArrayAdapter adapter=new MySimpleArrayAdapter(ShowListCategoryActivity2.this, R.layout.my_layout_for_show_list_data, list);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Toast.makeText(ShowListCategoryActivity2.this,"View->"+ list.get(position).toString(), Toast.LENGTH_LONG).show();
    }

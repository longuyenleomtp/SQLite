...
public class ShowListCategoryActivity extends Activity{
    ...
    public void updateUI()
    {
        ...
        if(database!=null)
        {
            ...
            header.setField2("Mã loại máy tính");
            header.setField3("Tên loại máy tính");
            list.add(header);
            cursor.moveToFirst();
            ...
            cursor.close();
            adapter=new MySimpleArrayAdapter(ShowListCategoryActivity.this, R.layout.my_layout_for_show_list_data, list);
            ...
            lv.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                                        int arg2, long arg3) {
                    // TODO Auto-generated method stub
                    Toast.makeText(ShowListCategoryActivity.this,"View -->"+ list.get(arg2).toString(), Toast.LENGTH_LONG).show();
                    Intent intent=new Intent(ShowListCategoryActivity.this, CreateAuthorActivity.class);
                ...
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                    ...
                    b.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            // TODO Auto-generated method stub
                            int n=database.delete("tblCategories", "id=?", new String[]{data.getField1().toString()});
                            if(n>0)
                            {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode==MainActivity.SEND_DATA_FROM_CATEGORY_ACTIVITY)
        {
            ...
            if(database!=null)
            {
                int n=database.update("tblCategories", values, "id=?", new String[]{f1});
                if(n>0)
                {

 ...
 *
 */
public class InsertComputerActivity<InforData, MySimpleArrayAdapter> extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(database!=null)
        {
            ...
            Cursor cursor=database.query("tblCategories", null, null, null, null, null, null);
            cursor.moveToFirst();
        ...
        adapter=new MySimpleArrayAdapter(InsertComputerActivity.this, R.layout.my_layout_for_show_list_data,listCategory);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        pinner.setAdapter((SpinnerAdapter) adapter);
        ...
        pinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                else
                {
                    ...
                    categoryData=listComputer.get(arg2);
        ...
        Button btnInsertComputer =(Button) findViewById(R.id.buttonInsertComputer);
        btnInsertComputer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                values.put("categoryid", categoryData.getField1().toString());
                long bId=database.insert("tblComputers", null, values);
                if(bId>0)
                {
    ...
    {
        Cursor cur=database.query("tblComputers", null, null, null, null, null, null);
        cur.moveToFirst();
        ...
        cur.close();
        adapter=new MySimpleArrayAdapter(InsertComputerActivity.this, R.layout.my_layout_for_show_list_data, listComputer);
    ...
    {
        Cursor cur=database.query("tblBooks", null, "authorid=?", new String[]{categoryid}, null, null, null);
        cur.moveToFirst();
        listComputer=new ArrayList<InforData>();
        while(cur.isAfterLast()==false)
        {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_insert_computer, menu);
        return true;
    }
}